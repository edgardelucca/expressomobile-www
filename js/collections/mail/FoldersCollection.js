define([
	...
	renameFolder: function(PfolderName, PfolderID, PglobalName) {
	    var that = this;
	    that._data = {};
	...
	addFolder: function(PfolderName, PparentFolderID, PparentGlobalName) {
	    var that = this;
	    that._data = {};
	    var thatModel = FoldersModel;
	    var data = this._data;
	...
	deleteFolder: function(PfolderID, PglobalName) {
	    var that = this;
	    that._data = {};
	    var thatModel = FoldersModel;
	    var data = this._data;
