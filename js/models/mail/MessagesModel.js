define([
	...
	delete: function(callbackSuccess, callbackFail) {
	    var that = this;
	    var currentFolder = Shared.folders.getFolderByID(this.get("folderID"));
	    
	    this.api
		    .resource(this.deleteResource)
		    .params({folderID: this.get("folderID"), msgID: this.get("msgID"), folderType: currentFolder.get('folderType')})
		    .done(function(result) {
			callbackSuccess(result);
		    })
		    .fail(function(error) {
